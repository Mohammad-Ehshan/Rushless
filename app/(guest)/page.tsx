...
export default function Home() {
  return (
    <main className="sm:container">
      ...
      <section className="hidden lg:block pt-16 pb-32">
        <div className="grid grid-cols-3 place-items center">
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col bg-orange-500 text-white relative justify-center items-center rounded-full w-12 h-12">
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col bg-orange-500 text-white relative justify-center items-center rounded-full w-12 h-12">
              ...
              before:-left-[920px] before:bg-orange-500
      ...
      <section>
        <div className="pt-16 w-full absolute left-0 sm:bg-map bg-cover bg-no-repeat bg-center bg-orange-600 bg-opacity-25 
        bg-blend-overlay">
          <div className="grid grid-cols-1 sm:grid-cols-2 container pb-16 place-items-center sm:place-items-start">
            ...
            <div className="pt-8 sm:pt-0">
              <Image alt="mobile" width={320} height={400}
              src="/mobile.png" />
            </div>
          </div>
