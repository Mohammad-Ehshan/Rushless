    ...
    <>
      {paymentIntent.status === "succeeded" ? (
        <main className="sm:container flex flex-col items-center pt-16">
          ...
          <div className="flex flex-col p-1 sm:p-0 itemcen">
            <div className="grid grid-cols-2 place-items-center">
              <p className="text-zinc-700">Parking at:</p>
              <p className="text-zinc-700 place-self-start">{address}</p>
            </div>
            <div className="grid grid-cols-2 place-items-center ">
              <p className="text-zinc-700">Arriving on:</p>
              <p className="text-zinc-700 place-self-start">
                {date} {arrivingon}
              </p>
            </div>
            <div className="grid grid-cols-2 place-items-center ">
              <p className="text-zinc-700">Leaving on:</p>
              <p className="text-zinc-700 place-self-start">
                {date} {leavingon}
              </p>
            </div>
            <div className="grid grid-cols-2 place-items-center ">
              <p className=" text-zinc-700">Plate no:</p>
              <p className="text-zinc-700 place-self-start">
                {plate.toUpperCase()}
              </p>
            </div>
