...
import LocationToggleSwitch from "./locationEnableSwitch"
            ...
            <CardContent>
                <div className="mb-4 grid grid-cols-1 items-start pb-4">
                    <div className="space-y-2">
                        <p className="text-sm font-medium leading-none">Hourly price: {formatAmountForDisplay(price.hourly, 'Rs')}</p>
