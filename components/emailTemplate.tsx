...
function EmailTemplate(props: EmailTemplateProps) {
  const { firstName, bookingDate, arrivingOn, leavingOn, plateNo, address } =
    props;
  return (
    <Html>
      <Head />
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          >
            Thank you for booking a spot with us!
          </Text>
          <Text
            style={{
              fontSize: "22px",
          ...
          <Section style={track.container}>
            ...
            <Row>
              ...
              <Column align="right">
                <Text style={{ fontSize: "18px", textTransform: "uppercase" }}>
                  {plateNo}
                </Text>
              </Column>
            </Row>
          ...
          <Section>
            ...
            <Row>
              <Text style={footer.text}>
                © 2025 Parkify, Inc. All Rights Reserved.
              </Text>
            </Row>
          </Section>
        </Container>
